...
class Scene:
    ...
    def render(self):
        ...
        tk.Label(control_frame, text="Наклон по X (Δ):").grid(row=0, column=0, padx=5, pady=2)
        tilt_x_var = tk.DoubleVar(value=0)
        tilt_x_entry = tk.Entry(control_frame, textvariable=tilt_x_var, width=5)
        tilt_x_entry.grid(row=0, column=1, padx=5, pady=2)

        tk.Label(control_frame, text="Наклон по Y (Δ):").grid(row=1, column=0, padx=5, pady=2)
        tilt_y_var = tk.DoubleVar(value=0)
        tilt_y_entry = tk.Entry(control_frame, textvariable=tilt_y_var, width=5)
        tilt_y_entry.grid(row=1, column=1, padx=5, pady=2)

        tk.Label(control_frame, text="Наклон по Z (Δ):").grid(row=2, column=0, padx=5, pady=2)
        tilt_z_var = tk.DoubleVar(value=0)
        tilt_z_entry = tk.Entry(control_frame, textvariable=tilt_z_var, width=5)
